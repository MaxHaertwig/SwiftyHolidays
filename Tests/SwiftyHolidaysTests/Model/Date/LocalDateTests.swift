...
final class LocalDateTests: XCTestCase {
    ...
    func testInitWithInvalidYearMonthDay() {
        XCTAssertNil(LocalDate(year: 0, month: 3, day: 16))
        XCTAssertNil(LocalDate(year: 2020, month: 0, day: 16))
        XCTAssertNil(LocalDate(year: 2020, month: 2, day: 30))
    }
    ...
    func testInitWithInvalidYearMonthEnumDay() {
        XCTAssertNil(LocalDate(year: 0, month: .march, day: 16))
        XCTAssertNil(LocalDate(year: 2020, month: .february, day: 30))
    }
    ...
    func testInitWithDateTimeZone() {
        ...
        XCTAssertEqual(LocalDate(date: date, timeZone: cet), LocalDate(year: 2020, month: 3, day: 17))
    }
    ...
    static var allTests = [
        ...
        ("testInitWithInvalidYearMonthDay", testInitWithInvalidYearMonthDay),
        ("testInitWithYearMonthEnumDay", testInitWithYearMonthEnumDay),
        ("testInitWithInvalidYearMonthEnumDay", testInitWithInvalidYearMonthEnumDay),
